  ...
  "feature": [
    ...
    },
    {
      ...
      "verification": [
        ...
        "External agents are discovered as <VIMAI_EXTERNAL_AGENTS_DIR>/<name>/run-agent wrappers, with run-agent.bat and run-agent.cmd accepted on Windows",
